package com.dhia.ecommerce.email;

import com.dhia.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        mimeMessageHelper.setFrom("contact@dhia.com");
        ...
        try{
            ...
            log.info(String.format("Email sent successfully to "+destinationEmail));

        }catch (MessagingException e){
            log.warn(String.format("can not send email to "+destinationEmail));
        }
